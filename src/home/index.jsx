    ...
    <div>
      ...
      width={1200} height={300} /> */}
        ...
        <section className="py-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <h2 className="text-md text-gray-500">Get your resume ready without any hassle with minimal efforts.</h2>
         ...
         hover:border-pink-500/10 hover:shadow-pink-500/10"
            ...
            >
              ...
              <h2 className="mt-4 text-xl font-bold text-black">Write get summary from AI for your resume</h2>

              <p className="mt-1 text-sm text-gray-600">
                Create AI generated summary for the resume and get better resume.
              </p>
            </a>
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-600">
                Anytime edit your existing resume and make required changes.
              </p>
            </a>
            ...
            >
              ...
              <h2 className="mt-4 text-xl font-bold text-black">Share & Start Accepting Feedbacks</h2>

              <p className="mt-1 text-sm text-gray-600">
                Download your resume in pdf format or share with friends, family and colleagues.
              </p>
            </a>
